...
import { ArrowDownIcon, BriefcaseIcon } from "../icons/icons.components";
            ...
            <dl className="flex flex-auto flex-wrap gap-x-2">
              ...
              <dd
                ...
                aria-label={`${role.start} until ${
                  role.end.dateTime.toLocaleString() ?? role.end
                }`}
              >
                <time dateTime={role.start}>{role.start}</time>{" "}
                <span aria-hidden="true">—</span>{" "}
                <time dateTime={role.end.dateTime.toLocaleString() ?? role.end}>
